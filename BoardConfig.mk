...
# Android 9 build_image.py consumes the *IMAGE* variable.  The scatter
# confirms S1S system is 0xc0000000 bytes (3 GiB).
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 3221225472
BOARD_SYSTEM_PARTITION_SIZE := 3221225472
# OTA block-image generation also needs the physical cache partition size.
# S1S scatter: cache = 0x1b000000 (432 MiB).
